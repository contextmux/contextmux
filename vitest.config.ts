 ...
 */
const PACKAGES = [
  'core', 'council', 'trajectory', 'context', 'repo', 'forge-github', 'runner-local', 'agent-cli', 'tracker-file', 'tracker-github', 'tracker-jira', 'agent-claude', 'agent-copilot', 'agent-cursor', 'agent-codex', 'agent-local', 'eval', 'learn', 'handoff', 'mcp-repo', 'cli',
]
